...
const Services = () => {
  const [whichService, setWhichService] = useState("App development");
  return (
    <div className="relative isolate overflow-hidden px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <svg
          className="absolute left-[max(50%,25rem)] top-0 h-[64rem] w-[128rem] -translate-x-1/2 stroke-gray-00 [mask-image:radial-gradient(64rem_64rem_at_top,white,transparent)]"
          aria-hidden="true"
        >
          <defs>
            <pattern
                ...
                {services.map((x, index) => (
                  ...
                  >
                    ...
                    <span>
                      ...
                      <br />
                      <span className="text-dimWhite"> {x.desc}</span>
                    </span>
                  </li>
                ))}
              </ul>
