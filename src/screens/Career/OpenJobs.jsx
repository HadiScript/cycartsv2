  ...
  return (
    <>
      <SectionTitle title="Open Positions">
        We're currently looking talent software engineers, and designers to help
        us in our missions and to grow up.
      </SectionTitle>
      ...
      <div className="max-w-screen-lg mx-auto px-4 md:px-8">
        <ul className="mt-12 divide-y space-y-3">
          {members.map((item, idx) => (
            <li
              key={idx}
              className="px-4 py-5 duration-150 hover:border-white hover:rounded-xl hover:bg-gray-900"
            >
