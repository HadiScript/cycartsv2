              ...
              {navigation.map((item, idx) => {
                return (
                  <li key={idx}>
                    {item.isDrapdown ? (
                      <button
                        className="w-full flex items-center justify-between gap-1 text-dimWhite hover:text-indigo-600"
                        onClick={() =>
                          setDrapdownState({
                            idx,
                      ...
                      <a
                        href={item.path}
                        className="block text-dimWhite hover:text-indigo-600"
                      >
                        {item.title}
                      </a>
                    )}
                                ...
                                {dropdownItem.navs.map((navItem, idx) => (
                                  <li key={idx} className="group">
                                    ...
                                    >
                                      ...
                                      <div>
                                        <span className="text-dimWhite duration-200 group-hover:text-indigo-600 text-sm font-medium md:text-base">
                                          {navItem.title}
                                        </span>
                                        <p className="text-sm text-gray-600 group-hover:text-dimWhite mt-1">
                                          {navItem.desc}
                                        </p>
                                      </div>
                                    </a>
